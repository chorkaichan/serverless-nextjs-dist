...
class CoreBuilder {
    constructor(buildOptions) {
        ...
        this.nextTargetDir = path_2.default.join(this.dotNextDir, buildOptions && buildOptions.outputFileTracing
            ? "server"
            : "serverless");
    ...
    getDefaultHandlerFileFilter(hasAPIRoutes, pageManifest) {
        return (file) => {
            ...
            const isNotExcludedJSFile = hasAPIRoutes ||
                ...
                this.isSSRJSFile(pageManifest, (0, pathToPosix_1.default)(path_2.default.relative(path_2.default.join(this.nextTargetDir, "pages"), file)) // important: make sure to use posix path to generate forward-slash path across both posix/windows
                );
    ...
    async copyChunks(handlerDir) {
        return (await fs_extra_1.default.pathExists((0, path_1.join)(this.nextTargetDir, "chunks")))
            ? fs_extra_1.default.copy((0, path_1.join)(this.nextTargetDir, "chunks"), (0, path_1.join)(this.outputDir, handlerDir, "chunks"))
            : Promise.resolve();
    }
    /**
