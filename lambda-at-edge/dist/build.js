...
const copyOutputFileTraces_1 = require("./lib/copyOutputFileTraces");
const copyRequiredServerFiles_1 = require("./lib/copyRequiredServerFiles");
...
class Builder {
    constructor(nextConfigDir, outputDir, buildOptions, nextStaticDir) {
        ...
        this.nextTargetDir = path_2.default.join(this.dotNextDir, buildOptions && buildOptions.outputFileTracing ? "server" : "serverless");
    ...
    async readPagesManifest() {
        const path = (0, path_1.join)(this.nextTargetDir, "pages-manifest.json");
    ...
    copyLambdaHandlerDependencies(fileList, reasons, handlerDirectory, base, omitPackageJson = true) {
        return fileList
            .filter((file) => {
            ...
            return ((!reason || reason.type !== "initial") &&
                (omitPackageJson ? file !== "package.json" : true));
        })
            .map((filePath) => {
            const resolvedFilePath = path_2.default.resolve((0, path_1.join)(base, filePath));
            const dst = (0, normalizeNodeModules_1.default)(path_2.default.relative(this.nextTargetDir, resolvedFilePath));
    ...
    async copyTraces(buildManifest, destination) {
        if (this.buildOptions.outputFileTracing) {
            ...
            const ssrPages = Object.values(allSsrPages).map((pageFile) => path_2.default.join(this.dotNextDir, "server", pageFile));
            await Promise.all([
                (0, copyOutputFileTraces_1.copyOutputFileTraces)({
                    serverlessDir: this.nextTargetDir,
                    destination: path_2.default.join(this.outputDir, destination),
                    pages: ssrPages
                }),
                (0, copyRequiredServerFiles_1.copyRequiredServerFiles)({
            ...
            const ssrPages = Object.values(allSsrPages).map((pageFile) => path_2.default.join(this.nextTargetDir, pageFile));
            ...
            await Promise.all(this.copyLambdaHandlerDependencies(Array.from(fileList), reasons, destination, base));
        }
    }
    async buildDefaultLambda(buildManifest, apiBuildManifest, separateApiLambda, useV2Handler) {
        var _a;
        const hasAPIRoutes = await fs_extra_1.default.pathExists((0, path_1.join)(this.nextTargetDir, "pages/api"));
        return Promise.all([
            ...
            fs_extra_1.default.copy((0, path_1.join)(this.nextTargetDir, "pages"), (0, path_1.join)(this.outputDir, exports.DEFAULT_LAMBDA_CODE_DIR, "pages"), {
                filter: (file) => {
                    ...
                    const isNotExcludedJSFile = hasAPIRoutes ||
                        ...
                        this.isSSRJSFile(buildManifest, (0, pathToPosix_1.default)(path_2.default.relative(path_2.default.join(this.nextTargetDir, "pages"), file)));
                    return (isNotApiPage &&
    ...
    async buildApiLambda(apiBuildManifest) {
        ...
        const apiPages = Object.values(allApiPages).map((pageFile) => path_2.default.join(this.nextTargetDir, pageFile));
        if (this.buildOptions.outputFileTracing) {
            promises.push((0, copyOutputFileTraces_1.copyOutputFileTraces)({
                serverlessDir: this.nextTargetDir,
                destination: path_2.default.join(this.outputDir, exports.API_LAMBDA_CODE_DIR),
                pages: apiPages
            }), (0, copyRequiredServerFiles_1.copyRequiredServerFiles)({
                nextConfigDir: this.nextConfigDir,
                destination: path_2.default.join(this.outputDir, exports.API_LAMBDA_CODE_DIR)
            ...
            promises.push(...this.copyLambdaHandlerDependencies(Array.from(fileList), reasons, exports.API_LAMBDA_CODE_DIR, base));
        }
        return Promise.all([
            ...promises,
            ...
            ((_a = this.buildOptions) === null || _a === void 0 ? void 0 : _a.handler)
                ...
                : Promise.resolve(),
            fs_extra_1.default.copy((0, path_1.join)(this.nextTargetDir, "pages/api"), (0, path_1.join)(this.outputDir, exports.API_LAMBDA_CODE_DIR, "pages/api")),
    ...
    async buildRegenerationHandler(buildManifest, useV2Handler) {
        await Promise.all([
            ...
            fs_extra_1.default.copy((0, path_1.join)(this.nextTargetDir, "pages"), (0, path_1.join)(this.outputDir, exports.REGENERATION_LAMBDA_CODE_DIR, "pages"), {
                filter: (file) => {
                    const isNotPrerenderedHTMLPage = path_2.default.extname(file) !== ".html";
                    const isNotStaticPropsJSONFile = path_2.default.extname(file) !== ".json";
    ...
    async copyChunks(handlerDir) {
        const { useServerlessTraceTarget, outputFileTracing } = this.buildOptions;
        if (useServerlessTraceTarget || outputFileTracing)
            return;
        const hasChunks = fs_extra_1.default.existsSync((0, path_1.join)(this.nextTargetDir, "chunks"));
        if (hasChunks) {
            await fs_extra_1.default.copy((0, path_1.join)(this.nextTargetDir, "chunks"), (0, path_1.join)(this.outputDir, handlerDir, "chunks"));
        }
    }
    async copyJSFiles(handlerDir) {
        if (this.buildOptions.outputFileTracing)
            return;
        await Promise.all([
            (await fs_extra_1.default.pathExists((0, path_1.join)(this.nextTargetDir, "webpack-api-runtime.js")))
                ? fs_extra_1.default.copy((0, path_1.join)(this.nextTargetDir, "webpack-api-runtime.js"), (0, path_1.join)(this.outputDir, handlerDir, "webpack-api-runtime.js"))
                : Promise.resolve(),
            (await fs_extra_1.default.pathExists((0, path_1.join)(this.nextTargetDir, "webpack-runtime.js")))
                ? fs_extra_1.default.copy((0, path_1.join)(this.nextTargetDir, "webpack-runtime.js"), (0, path_1.join)(this.outputDir, handlerDir, "webpack-runtime.js"))
                : Promise.resolve()
        ]);
    }
    ...
    async buildStaticAssets(defaultBuildManifest, routesManifest, ignorePatterns) {
        ...
        const copyBuildId = copyIfExists(path_2.default.join(this.dotNextDir, "BUILD_ID"), path_2.default.join(assetOutputDirectory, withBasePath("BUILD_ID")));
        const buildStaticFiles = await (0, readDirectoryFiles_1.default)(path_2.default.join(this.dotNextDir, "static"), ignorePatterns);
        ...
        const htmlAssets = [...htmlFiles, ...fallbackFiles].map((file) => {
            const source = path_2.default.join(this.nextTargetDir, `pages${file}`);
    ...
    async build(debugMode) {
        var _a, _b;
        const { cmd, args, cwd, env, useServerlessTraceTarget, cleanupDotNext, assetIgnorePatterns, separateApiLambda, useV2Handler, outputFileTracing } = Object.assign(defaultBuildOptions, this.buildOptions);
        await Promise.all([
